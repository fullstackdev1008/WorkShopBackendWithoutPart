...
DO $$ BEGIN
 CREATE TYPE "public"."job_card_status" AS ENUM('DRAFT', 'PENDING_PARTS', 'PARTS_CONFIRMED', 'SHARED', 'APPROVED', 'PARTIALLY_APPROVED', 'REJECTED', 'MODIFICATION_REQUESTED', 'IN_SERVICE', 'COMPLETED');
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
...
CREATE UNIQUE INDEX IF NOT EXISTS "uq_slot_configurations_time" ON "slot_configurations" USING btree ("time");--> statement-breakpoint
CREATE UNIQUE INDEX IF NOT EXISTS "uq_users_email" ON "users" USING btree ("email");--> statement-breakpoint
CREATE UNIQUE INDEX IF NOT EXISTS "uq_users_username" ON "users" USING btree ("username");--> statement-breakpoint
...
CREATE UNIQUE INDEX IF NOT EXISTS "uq_vehicles_vin" ON "vehicles" USING btree ("vin");--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS "idx_vehicles_dealer_id" ON "vehicles" USING btree ("dealer_id");